...
static const mm_word sfx_map[SFX_COUNT] = {
    ...
    [SFX_BEAM_FIRE]      = SFX_31_BEAM_FIRE,
    [SFX_LASER_CRACK]    = SFX_32_LASER_CRACK,
    [SFX_NOVA_WHOOSH]    = SFX_33_NOVA_WHOOSH,
    [SFX_HOMING_WHINE]   = SFX_34_HOMING_WHINE,
    [SFX_ENEMY_HIT_MECH] = SFX_35_ENEMY_HIT_MECH,
    [SFX_ENEMY_DIE_MECH] = SFX_36_ENEMY_DIE_MECH,
    [SFX_ENEMY_HIT_DIGI] = SFX_37_ENEMY_HIT_DIGI,
    [SFX_ENEMY_DIE_DIGI] = SFX_38_ENEMY_DIE_DIGI,
};
